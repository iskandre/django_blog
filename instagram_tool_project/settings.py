"""
Django settings for instagram_tool_project project.
...
ROOT_URLCONF = 'instagram_tool_project.urls'
...
WSGI_APPLICATION = 'instagram_tool_project.wsgi.application'
...
STATIC_URL = '/static/'
STATIC_ROOT = '/static/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'cached_data')
MEDIA_URL = '/cached_data/'
